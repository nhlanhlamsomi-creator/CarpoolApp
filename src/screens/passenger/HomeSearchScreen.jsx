...
const SearchIcon = () => (
  <Svg width="18" height="18" viewBox="0 0 24 24" fill="none">
    ...
    <Path d="M16.5 16.5L21 21" stroke={colors.white} strokeWidth="2" strokeLinecap="round"/>
  </Svg>
);
...
const GiftIcon = () => (
  <Svg width="28" height="28" viewBox="0 0 24 24" fill="none">
    <Path d="M20 12v10H4V12M22 7H2v5h20V7zM12 22V7M12 7H7.5a2.5 2.5 0 010-5C11 2 12 7 12 7zM12 7h4.5a2.5 2.5 0 000-5C13 2 12 7 12 7z" stroke={colors.primaryDark} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
  </Svg>
);
...
const styles = StyleSheet.create({
  ...
  dateRow:        { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, borderTopWidth: 1, borderTopColor: colors.border, paddingTop: spacing.sm, marginBottom: spacing.sm },
  dateInput:      { flex: 1, fontSize: typography.fontSize.base, color: colors.textPrimary, paddingVertical: 8 },
  searchBtn:      { backgroundColor: colors.primary, borderRadius: radius.full, paddingVertical: 14, alignItems: 'center', flexDirection: 'row', justifyContent: 'center', gap: spacing.sm },
  ...
  recentMeta:     { alignItems: 'flex-end', marginRight: spacing.sm },
